...
<body>
    <nav class="navbar d-flex align-items-center justify-content-between px-4">
        ...
        <div class="d-flex align-items-center gap-4">
            <!-- Dashboard Link -->
            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline-secondary <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary">Login</a>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="components">
                <li class="<?php echo e(request()->routeIs('logistics.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('logistics.index')); ?>">
                        <i class="fas fa-truck"></i> Logistics
                    </a>
                </li>
                <li class="<?php echo e(request()->routeIs('utilities.*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('utilities.index')); ?>">
...
<?php /**PATH C:\xampp\htdocs\smart-urban-management\resources\views/layouts/app.blade.php ENDPATH**/ ?>